adabots = {
  config = {
    ...
    build_energy_cost = tonumber(minetest.settings:get("adabots_build_energy_cost")) or 10,
    mine_energy_cost = tonumber(minetest.settings:get("adabots_mine_energy_cost")) or 10,
  },
  turtles = {},
  num_turtles = 0,
  workspaces = {}
